...
# def delete_orphaned_words(session, word_class, association_class):
#     orphaned_words = session.query(word_class).filter(
#         ~word_class.id.in_(
#             session.query(association_class.russian_word_id if word_class == RussianWord else association_class.english_word_id)
#         )
#     ).all()
...
# def delete_orphan_words(session, context):
#     delete_orphaned_words(session, RussianWord, RussianEnglishAssociation)
#     delete_orphaned_words(session, EnglishWord, RussianEnglishAssociation)
